...
Nachdem Sie eine Domäne zum Senden von E-Mails an die Adobe delegiert haben (siehe [Domain name setup](/help/additional-resources/ac-domain-name-setup.md)), erstellt und verwendet die Adobe bestimmte Subdomänen für bestimmte Funktionen.
